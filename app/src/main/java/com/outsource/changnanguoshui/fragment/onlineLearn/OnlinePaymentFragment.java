...
import com.outsource.changnanguoshui.adapter.onlineLearn.PaymentAdapter;
...
public class OnlinePaymentFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        paymentAdapter = new PaymentAdapter(getActivity(), setOnlineData());
        recycleOnline.setAdapter(paymentAdapter);
    }
