...
public class PartyBuildingFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, CommonBaseAdapter.onItemClickerListener{
    int type;
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        adapter = new PartyBuildingFragment.MyAdapter(getActivity(), R.layout.item_party_building, data);
    ...
    public void onItemClick(View view, Object data, int position) {
        ...
        intent.putExtra("activityTitle", "风采内容");
