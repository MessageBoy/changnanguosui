 ...
 */
public class OnlineLearnFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, CommonBaseAdapter.onItemClickerListener
{
    ...
    protected void initData()
    {
        ...
        adapter = new MyAdapter(getActivity(), R.layout.item_online_file, mData);
