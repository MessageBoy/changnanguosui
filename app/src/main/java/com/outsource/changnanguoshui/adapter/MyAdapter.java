...
//         * 设置网络图片
//         */
//        public ViewHolder setImaged(int id, String url)
//        {
//            View view = getView(id);
//            if (view instanceof ImageView)
//            {
//                imageLoader.displayImage(IMGURL + "/dc/attach/downloadFile?id=" + url, (ImageView) view, options);
//            }
//            return this;
//        }
//
...
//            if (view instanceof ImageView)
//            {
//                PicassoUtils.loadImage(context, IMGURL + url, (ImageView) view);
//            }
//            return this;
//        }
