...
//                Log.d(VIEW_LOG_TAG, "### 找到listview");  
    ...
    {
        Log.e("ssss", isBottom() + "     " + isLoading + "     " + isPullUp());
    ...
    private boolean isBottom()
    {
        ...
        {
            Log.e("getLastVisiblePosition", mListView.getLastVisiblePosition() + "---" + (mListView.getAdapter().getCount() - 1));
...
//            mListView.removeFooterView(mListViewFooter);  
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
                         int totalItemCount)
    {
        Log.e("onScroll", "onScroll(AbsListView view, int firstVisibleItem");
        // 滚动时到了最底部也可以加载更多  
        if (canLoad())
        {
            loadData();
